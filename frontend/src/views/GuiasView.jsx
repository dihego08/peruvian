              ...
              <tr key={g.id} className="hover:bg-gray-50 transition-colors">
                ...
                <td className="px-4 py-3">
                  <div className="flex items-center justify-center gap-1">
                    ...
                    <a
                      href={`${import.meta.env.VITE_API_BASE_URL || 'https://apiomcar.dbusinessaqp.com/api'}/guias/${g.id}/pdf`}
                      target="_blank"
                      rel="noreferrer"
          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-4xl overflow-hidden animate-in zoom-in-95 duration-300">
            ...
            <div className="flex justify-end gap-3 px-6 py-4 border-t border-gray-100 bg-gray-50">
              ...
              {detailData?.cabecera?.estado == 1 && (
                <a
                  href={`${import.meta.env.VITE_API_BASE_URL || 'https://apiomcar.dbusinessaqp.com/api'}/guias/${detailData.cabecera.id}/pdf`}
                  target="_blank"
                  rel="noreferrer"
