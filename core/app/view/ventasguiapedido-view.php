...
if ($accion != "") {
	switch ($accion) {
		case 'filtrar':
			...
			//echo("entro");
			$ventas = new SellData();
			$rsVentas = $ventas->lista_rep_ventas_guia_pedido($desde, $hasta);
			break;
	}
}
...
<section class="content">
	<div class="row">
		<div class="col-md-12">
			<!-- Single button -->
			<h3><i class="glyphicon glyphicon-stats"></i> Ventas Guias y Pedidos</h3>
			<!--<a onclick="thePDF()" class="btn btn-default">Descargar PDF</a><br><br>-->
			<div class="clearfix"></div>
			<div class="box">
				<div class="box-header">
					<fieldset>
						<form action="index.php?view=ventasguiapedido&act=filtrar" method="post">
							...
							<div class="form-row">
								...
								<div class="form-group col-md-12 text-center">
									<input type="submit" class="btn btn-success rounded-pill" value="Buscar por Fecha" />
								</div>
							</div>
						</form>
					</fieldset>
					...
					<div class="table-responsive">
						<table class="table table-bordered datatable table-hover" id="tabla_lista">
							...
							<tbody>
								...
								if (count($rsVentas) > 0) {
									// si hay datos
									foreach ($rsVentas as $venta) { ?>
										<tr>
											<td><?php echo $venta->fecha; ?></td>
											<td><?php echo $venta->venta; ?></td>
											<td><?php echo $venta->guia; ?></td>
