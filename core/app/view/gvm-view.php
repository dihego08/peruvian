                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <button style="margin-bottom: 0.5rem;" class="btn-xs btn btn-success" id="btn_guardar" onclick="guardar_gvm();">Agregar</button>
...
<script>
    ...
    function guardar_gvm() {
        if (
            ...
            $.post("core/app/view/costos.php?parAccion=guardar_gvm", {
    ...
    function limpiar() {
        ...
        $("#btn_guardar").attr("onclick", "guardar_gvm();");
    }
    ...
    function extraer_gvm() {
        ...
        $.post("core/app/view/costos.php?parAccion=extraer_gvm", function(response) {
            var obj = JSON.parse(response);
            var total_mes = 0;
            var total_dia = 0;
