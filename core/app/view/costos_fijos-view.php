                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <button style="margin-bottom: 0.5rem;" class="btn-xs btn btn-success" id="btn_guardar" onclick="guardar_costos_fijos();">Agregar</button>
...
<script>
    ...
    function guardar_costos_fijos() {
        if (
            ...
            $.post("core/app/view/costos.php?parAccion=guardar_costos_fijos", {
    ...
    function limpiar() {
        ...
        $("#btn_guardar").attr("onclick", "guardar_costos_fijos();");
    }
    ...
    function extraer_costos_fijos() {
        ...
        $.post("core/app/view/costos.php?parAccion=extraer_costos_fijos", function(response) {
            var obj = JSON.parse(response);
            var total_mes = 0;
            var total_dia = 0;
