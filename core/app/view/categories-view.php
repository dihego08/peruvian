...
<div class="box">
  ...
  <div class="box-body">
      ...
      <th>Imagen</th>
        ...
        <td>
          <?php if($user->image!=""):?>
            <img src="storage/products/<?php echo $user->image;?>" style="width:64px;">
          <?php endif;?>
        </td>
  ...
  <div class="row">
  	<div class="col-md-12">
        ...
        <div class="box box-primary">
          <table class="table">
          <tr><td>
        		<form class="form-horizontal" method="post" id="addcategory" enctype="multipart/form-data" action="index.php?action=categories&opt=add" role="form">
...
<div class="row">
  ...
  <table class="table">
  <tr><td>
		<form class="form-horizontal"  method="post" id="addproduct" action="index.php?action=categories&opt=upd" enctype="multipart/form-data" role="form">
      ...
      <div class="form-group">
        ...
        <div class="col-md-6">
          ...
          <br>
          <img src="storage/products/<?php echo $user->image;?>" class="img-responsive">
        </div>
      </div>
      <div class="form-group">
        <div class="col-lg-offset-2 col-lg-10">
