	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="w-100 text-right mb-1">
				<a href="index.php?view=newclient" class="btn btn-outline-dark rounded-pill"><i class='fa fa-smile-o'></i> Nuevo Cliente</a>
				<div class="btn-group ">
					<button type="button" class="btn btn-outline-dark dropdown-toggle rounded-pill" data-toggle="dropdown">
						...
						<table class="table table-bordered datatable table-hover">
							...
							?>
								<tr>
									...
									<td><?php if ($user->has_credit) {
											echo "<i class='fa fa-check'></i>";
										}; ?></td>
									<td style="width:130px;">
										<a href="index.php?view=editclient&id=<?php echo $user->id; ?>" class="d-block mt-1 btn btn-outline-warning btn-xs rounded-pill">Editar</a>
										<a href="index.php?view=delclient&id=<?php echo $user->id; ?>" class="d-block mt-1 btn btn-outline-danger btn-xs rounded-pill">Eliminar</a>
										<a href="index.php?view=prodclient&id=<?php echo $user->id; ?>" class="d-block mt-1 btn btn-outline-success btn-xs rounded-pill">Productos</a>
									</td>
								</tr>
							<?php
