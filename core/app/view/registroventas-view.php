...
<div class="row">
	...
	<h1>Registro de ventas</h1>
						...
						<form>
						<input type="hidden" name="view" value="registroventas">
<div class="row">
<div class="col-md-2">
...
<?php foreach($operations as $operation):?>
	<tr>
		...
		<td><?php echo Core::$symbol; ?> <?php echo number_format($v_venta,2,'.',','); ?></td>

		<td><?php echo Core::$symbol; ?> <?php echo number_format($operation->total,2,'.',','); ?></td>

		<td><?php echo Core::$symbol; ?> <?php echo number_format($IGV,2,'.',','); ?></td>

		<td><?php echo Core::$symbol; ?> <?php echo number_format($operation->detraccion,2,'.',','); ?></td>

		<td><?php echo Core::$symbol; ?> <?php echo number_format($IGV - $operation->detraccion,2,'.',','); ?></td>

		<td><?php echo Core::$symbol; ?> <?php echo number_format($v_venta * 0.02,2,'.',','); ?></td>

		<td><?php echo Core::$symbol; ?> <?php echo number_format($operation->total - $operation->detraccion,2,'.',','); ?></td>


		<td><?php echo $operation->fecpago; ?></td>
		<td><?php echo $operation->entidad; ?></td>
		<td><?php echo $operation->fecdetrac; ?></td>
