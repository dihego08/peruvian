		...
		<div class="col-md-12">
			...
			<div class="form-row">
				...
				<div class="col-md-6">
					...
					<input type="text" class="form-control rounded-pill rounded-pill" id="fecha" value="<?php echo date("Y-m-d") ?>">
				</div>
				<div class="col-md-4">
				...
				<div id="resultado_busqueda_order">
					...
					<div class="col-md-12">
						...
						<div class="row w-100 text-right">
							...
							<button class="btn btn-success rounded-pill" id="guardar_venta">Guardar O.C.</button>
						</div>
					</div>
				</div>
			</div>
					...
					$("#guardar_venta").click(function() {
						if ($("#id_proveedor").val() == 0 && $("#id_proveedor").val() == "" && $("#id_proveedor").val() == "-1") {
							...
							if (contador == 0) {
								...
								console.log(tipos_productos);
								console.log(descripciones);
								console.log(cantidades);
								console.log(precios);
								$.get('core/app/view/compra.php', {
									parAccion: 'insertar_orden_compra',
