                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" class="form-control" id="moi_n_trabajador">
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <button style="margin-bottom: 0.5rem;" class="btn-xs btn btn-success" id="btn_guardar" onclick="guardar_moi();">Agregar</button>
...
<script>
    ...
    function guardar_moi() {
        if (
            ...
            $.post("core/app/view/costos.php?parAccion=guardar_MOI", {
    ...
    function limpiar() {
        ...
        $("#btn_guardar").attr("onclick", "guardar_moi();");
    }
    ...
    function extraer_moi() {
        ...
        $.post("core/app/view/costos.php?parAccion=extraer_MOI", function(response) {
            var obj = JSON.parse(response);
            var total_mes = 0;
            var total_dia = 0;
            $.each(obj, function(index, val) {
                total_mes += parseFloat(val.sueldo_mes);
                total_dia += parseFloat(val.sueldo_dia);
                $("#lista_moi").find("tbody").append(`
                    <tr>
                        <td>${val.moi_concepto}</td>
                        <td>${val.moi_sueldo_mes}</td>
                        <td>${val.moi_n_trabajador }</td>
                        <td>${val.moi_dia_mes }</td>
                        <td>${val.moi_horas_dia }</td>
                        <td>S/ ${val.sueldo_mes }</td>
                        <td>S/ ${val.sueldo_dia }</td>
                        <td>
