<section class="content">
  <div class="row">
    <div class="col-md-12">
      ...
      <button type="button" class="btn btn-outline-dark rounded-pill" data-toggle="modal" data-target="#myModal">
        Importar datos
      </button>

      <button type="button" class="btn btn-outline-dark rounded-pill" data-toggle="modal" data-target="#myModal2">
        Instrucciones
      </button>
      <!-- Modal -->
