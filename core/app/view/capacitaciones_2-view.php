		...
		<div class="col-md-12">
			...
			<div class="box">
				<div class="box-header">
					<div style="width: 100%; text-align: right;" class=" mt-1 mb-1">
						<a href="?view=asistencias" class="btn btn-outline-danger rounded-pill">Asistencias</a>
					</div>
									...
									<div class="row" id="div_formulario" style="background: wheat; border-radius: 4px; box-shadow: 0px 2px 2px #333; padding: 10px;">
										...
										<div id="div_add" class="form-row">
											...
											<div class="col-md-2" style="text-align: center;">
												...
												<span class="btn btn-success rounded-pill" onclick="add_elemento_to_form();">
			...
			<div class="box">
				...
				<div class="box-body">
					...
					<div class="col-md-12 text-center" style="width: 100%; text-align: center; margin-top: 0.5rem; margin-bottom: 1.5rem;">
						...
						<a href="core/app/view/pdf-cronograma.php" id="btn_pdf_cronograma" class="btn btn-info rounded-pill">PDF</a>
					</div>
...
<script type="text/javascript">
	...
	function get_tipos_cronograma() {
		$.post('core/app/view/colaborador.php?parAccion=get_tipos_cronograma', function(data) {
	...
	function add_elemento_to_form() {
		...
		$("#div_add").append(`
			...
			<div class="col-md-2 form_${aux_form} form_delete" style="text-align: center; margin-top: 0.5rem;">
				...
				<span class="btn btn-danger rounded-pill" onclick="remove_elemento_from_form(${aux_form});">
	...
	function get_cronograma(id = 0) {
		...
		$.post('core/app/view/colaborador.php?parAccion=get_cronograma', {
			...
			$.each(obj, function(index, val) {
				...
				cuerpo += `<tr>
					<td style="width: 86px;">
						<span class="btn-sm btn-outline-warning btn  rounded-pill " style="display: block; text-align: center;" onclick="editar(` + val.id + `);"><i class="glyphicon glyphicon-pencil"></i></span>
    					<span class="btn-sm btn-outline-danger btn  rounded-pill " style="margin-top: 0.5rem; display: block; text-align: center;" onclick="eliminar(` + val.id + `);"><i class="fa fa-trash"></i></span>
					</td>
	...
	function actualizar(id) {
		...
		if ($("#curso").val() == "" || $("#curso").val() == undefined || $("#_anio_").val() == "") {
			bootbox.alert({
				message: '<div class="alert alert-danger fade in" style="margin-top: 5%; margin-bottom: 0;">' +
