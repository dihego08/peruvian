			...
			<?php echo $r; ?>
                  ...
                  <td style="width:213px;">
                    ...
                    <?php if (Core::$user->kind == 1) : ?>
                      <a href="index.php?view=inventaryadd&product_id=<?php echo $product->id; ?>&stock=<?php echo $_GET["stock"]; ?>" class="btn btn-sm btn-outline-primary rounded-pill d-block mt-1"><i class="glyphicon glyphicon-plus"></i> Agregar</a>
                      <a href="index.php?view=inventarysub&product_id=<?php echo $product->id; ?>&stock=<?php echo $_GET["stock"]; ?>" class="btn btn-sm btn-outline-danger rounded-pill d-block mt-1"><i class="glyphicon glyphicon-plus"></i> Quitar</a>
                      <a href="index.php?view=history&product_id=<?php echo $product->id; ?>&stock=<?php echo $_GET["stock"]; ?>" class="btn btn-sm btn-outline-success rounded-pill d-block mt-1"><i class="glyphicon glyphicon-time"></i> Historial</a>
                    <?php endif; ?>
                  </td>
                </tr>
              <?php endforeach; ?>
