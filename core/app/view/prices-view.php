                      ...
                      <form method="post" action="./?action=updateprices">
                        ...
                        ?>
                          <div class="input-group mt-1 w-100">
                            ...
                            <input type="text" required class="form-control rounded-pill-right " value="<?php echo $price; ?>" name="price_<?php echo $stock->id; ?>_<?php echo $product->id; ?>" placeholder="Precio en <?php echo $stock->name; ?>">
                          </div>
                        <?php endforeach; ?>
                        <div class="w-100 text-right">
                          <input type="submit" value="Actualizar" class="btn btn-outline-success btn-sm mt-1 rounded-pill">
                        </div>
                      </form>
