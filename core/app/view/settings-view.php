          ...
          <table class="table table-bordered">
            <tbody>
              ...
              if (count($settings) > 0) : ?>
                <?php foreach ($settings as $cat) : ?>
                  <tr>
                    ...
                    <td>
                      <?php if ($cat->kind == 2) : ?>
                        <input type="text" name="<?php echo $cat->short; ?>" class="form-control rounded-pill" value="<?php echo $cat->val; ?>">
              ...
              <tr>
                ...
                <td>
                  <input type="submit" class="btn btn-success rounded-pill" value="Actualizar Ajustes">
                </td>
              </tr>
            </tbody>
          </table>
