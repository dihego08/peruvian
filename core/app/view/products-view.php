	...
	<div class="row">
		<div class="col-md-12">
						...
						<form class="form-horizontal" method="post" id="filter" action="index.php?view=products&act=filtrar" role="form">
							<fieldset>
								...
								<div class="col-md-3">
									...
									<select name="cmbCliente" id="cmbCliente" class="form-control rounded-pill">
			...
			<div class="w-100 d-block text-right">
				<?php
				?>
				<a href="index.php?view=newproduct" class="btn btn-outline-dark rounded-pill"><i class="fa fa-plus"></i> Agregar Producto</a>
								...
								?>
									...
									<?php foreach ($products as $product) : ?>
										<tr>
											...
											<td style="width:90px;">
												<a target="_blank" href="index.php?action=productqr&id=<?php echo $product->id; ?>" class="btn btn-sm btn-outline-dark rounded-pill d-block" <?php echo $cls; ?>><i class="fa fa-qrcode"></i></a>
												<a href="index.php?view=editproduct&id=<?php echo $product->id; ?>" class="btn btn-sm btn-outline-warning rounded-pill d-block mt-1" <?php echo $cls; ?>><i class="glyphicon glyphicon-pencil"></i></a>
												<a href="index.php?view=delproduct&id=<?php echo $product->id; ?>" class="btn btn-sm btn-outline-danger rounded-pill d-block mt-1" <?php echo $cls; ?>><i class="fa fa-trash"></i></a>
											</td>
										</tr>
									<?php endforeach; ?>
								<?php
									...
									<?php foreach ($products as $product) : ?>
										<tr>
											...
											<td>
												...
												?>
												<a <?php echo $cls; ?> class='label label-primary w-100 mt-1 block cursor' href="?view=costos_2&id_producto=<?php echo $product->id; ?>">Costos</a>
											</td>
											<td><?php if ($product->is_active) : ?><i class="fa fa-check"></i><?php endif; ?></td>
											<td style="width:90px;">
												<a target="_blank" href="index.php?action=productqr&id=<?php echo $product->id; ?>" class="btn btn-sm rounded-pill btn-outline-dark d-block" <?php echo $cls; ?>><i class="fa fa-qrcode"></i></a>
												<a href="index.php?view=editproduct&id=<?php echo $product->id; ?>" class="btn btn-sm rounded-pill btn-outline-warning d-block mt-1" <?php echo $cls; ?>><i class="glyphicon glyphicon-pencil"></i></a>
												<a href="index.php?view=delproduct&id=<?php echo $product->id; ?>" class="btn btn-sm rounded-pill btn-outline-danger d-block mt-1" <?php echo $cls; ?>><i class="fa fa-trash"></i></a>
											</td>
										</tr>
									<?php endforeach; ?>
								<?php
				...
				<div class="modal-body">
					...
					<div class="tab-content">
							...
							<div class="row">
								...
								<div class="form-row">
									<div class="col-md-3">
										...
										<input type="text" class="form-control" id="elaborado_por">
									</div>
									<div class="col-md-3">
										<label for="">
											Revisado por:
										</label>
										<input type="text" class="form-control" id="revisado_por">
									</div>
									<div class="col-md-3">
										<label for="">
											Aprobado por:
										</label>
										<input type="text" class="form-control" id="aprobado_por">
									</div>
									<div class="col-md-3">
										<label for="">
											Ultima Modificacion:
										</label>
										<input type="text" class="form-control" id="u_modificacion" readonly>
									</div>
								</div>
								<div class="col-md-12 mt-2 text-right">
									<a class="btn btn-default" id="para_pdf_ficha_1">Exportar PDF</a>
									<button class="btn btn-info" id="btn_ficha_tecnica"></button>
								</div>
							</div>
						</div>
						<div id="menu1" class="tab-pane fade">
							...
							<a class="btn btn-default" id="para_pdf_manual">Exportar PDF</a>
						</div>
						<div id="menu2" class="tab-pane fade">
							...
							<div class="row">
								<!--<div class="col-md-12 mt-2 text-right">
	              				<button class="btn btn-info" id="btn_medidas">Guardar</button>
	              			</div>-->
							</div>
							<a class="btn btn-default" id="para_pdf">Exportar PDF</a>
						</div>
					</div>
				</div>
...
<script type="text/javascript">
	...
	function get_complementos(num_modelo) {
		...
		$.post('core/app/view/fichaTecnica.php?parAccion=get_complementos', {
                ...
                <tr>
                  <td style="padding: .5rem;">
                    <div class="text-right">
                      <input class="form-control br-4" style="font-weight: bold; text-align: right;" type="text" id="txt_titulo_` + val.id + `" value="` + val.titulo + `">
                    </div>
                  </td>
                  <td style="padding: .5rem;">
                    <div>
                      <input class="form-control br-4" type="text" id="txt_complemento_` + val.id + `" value="` + val.complemento + `">
                    </div>
                  </td>
                  <td style="padding: .5rem;">
                    <span class="cursor w-100 btn btn-warning btn-xs" onclick="edit_complemento(` + val.id + `);"><i class="fa fa-pencil"></i></span>
                    <span class="cursor w-100 mt-1 btn btn-danger btn-xs" onclick="delete_complemento(` + val.id + `);"><i class="fa fa-trash"></i></span>
                  </td>
                </tr>
            `);
			});
            ...
            <td><input type="text" class="form-control" id="txt_titulo"></td>
            <td><input type="text" class="form-control" id="txt_complemento"></td>
            <td><span class="w-100 cursor btn btn-xs btn-success" onclick="guardar_complemento('` + num_modelo + `');"><i class="fa fa-plus"></i></span></td>
        </tr>`);
		});
	}
		...
		$.post('core/app/view/fichaTecnica.php?parAccion=get_identificacion', {
			...
			$.each(obj.Records, function(index, val) {
                ...
                <tr>
                  <td style="padding: .5rem;">
                    <div class="text-right">
                      <input class="form-control br-4" style="font-weight: bold; text-align: right;" type="text" id="txt_titulo_i_` + val.id + `" value="` + val.titulo + `">
                    </div>
                  </td>
                  <td style="padding: .5rem;">
                    <div>
                      <input class="form-control br-4" type="text" id="txt_complemento_i_` + val.id + `" value="` + val.complemento + `">
                    </div>
                  </td>
                  <td style="padding: .5rem;">
                    <span class="cursor w-100 btn btn-warning btn-xs" onclick="edit_identificacion(` + val.id + `);"><i class="fa fa-pencil"></i></span>
                    <span class="cursor w-100 mt-1 btn btn-danger btn-xs" onclick="delete_identificacion(` + val.id + `);"><i class="fa fa-trash"></i></span>
                  </td>
                </tr>
            `);
			});
            ...
            <td><input type="text" class="form-control" id="txt_titulo_i"></td>
            <td><input type="text" class="form-control" id="txt_complemento_i"></td>
            <td><span class="w-100 cursor btn btn-xs btn-success" onclick="guardar_identificacion('` + num_modelo + `');"><i class="fa fa-plus"></i></span></td>
        </tr>`);
		});
	}
		...
		$.post('core/app/view/fichaTecnica.php?parAccion=get_modificacion', {
			...
			$.each(obj.Records, function(index, val) {
                ...
                <tr>
                  <td style="padding: .5rem;">
                    <div class="text-right">
                      <input class="form-control br-4" style="font-weight: bold; text-align: right;" type="text" id="txt_titulo_m_` + val.id + `" value="` + val.titulo + `">
                    </div>
                  </td>
                  <td style="padding: .5rem;">
                    <div>
                      <input class="form-control br-4" type="text" id="txt_complemento_m_` + val.id + `" value="` + val.complemento + `">
                    </div>
                  </td>
                  <td style="padding: .5rem;">
                    <div>
                      <input class="form-control br-4" type="text" id="txt_fecha_m_` + val.id + `" value="` + val.fecha + `">
                    </div>
                  </td>
                  <td style="padding: .5rem;">
                    <span class="cursor w-100 btn btn-warning btn-xs" onclick="edit_modificacion(` + val.id + `);"><i class="fa fa-pencil"></i></span>
                    <span class="cursor w-100 mt-1 btn btn-danger btn-xs" onclick="delete_modificacion(` + val.id + `);"><i class="fa fa-trash"></i></span>
                  </td>
                </tr>
            `);
			});
			...
			$("#div_modificacion").append(`<tr>
            <td><input type="text" class="form-control" id="txt_titulo_m"></td>
            <td><input type="text" class="form-control" id="txt_complemento_m"></td>
            <td><input type="text" class="form-control" id="txt_fecha_m"></td>
            <td><span class="w-100 cursor btn btn-xs btn-success" onclick="guardar_modificacion('` + num_modelo + `');"><i class="fa fa-plus"></i></span></td>
        </tr>`);
		});
	}
	...
	function ficha_tecnica(num_modelo) {
		...
		$.post('core/app/view/fichaTecnica.php?parAccion=get_ficha', {
			...
			if (obj.Result == "OK") {
				...
				/*$("#txt_tejido").val(ficha.tejido);
				$("#txt_cinta").val(ficha.cinta);
				$("#txt_etiqueta").val(ficha.etiqueta);
				$("#txt_estampado").val(ficha.estampado);*/
			...
			$.each(obj.Records, function(index, val) {
				$("#tabla_medidas").find('tbody').append(`<tr>
    				<th><textarea class="form-control" style="width: 260px; resize: none;" type="text" value="` + val.descripcion + `" id="descripcion_` + val.id + `">` + val.descripcion + `</textarea></th>
	              	<td><input class="form-control" type="text" value="` + val.t_2 + `" id="t_2_` + val.id + `"></td>      
	              	<td><input class="form-control" type="text" value="` + val.t_4 + `" id="t_4_` + val.id + `"></td>
	              	<td><input class="form-control" type="text" value="` + val.t_6 + `" id="t_6_` + val.id + `"></td>
	              	<td><input class="form-control" type="text" value="` + val.t_8 + `" id="t_8_` + val.id + `"></td>
	              	<td><input class="form-control" type="text" value="` + val.t_10 + `" id="t_10_` + val.id + `"></td>
	              	<td><input class="form-control" type="text" value="` + val.t_12 + `" id="t_12_` + val.id + `"></td>
	              	<td><input class="form-control" type="text" value="` + val.t_14 + `" id="t_14_` + val.id + `"></td>
	              	<td><input class="form-control" type="text" value="` + val.t_16 + `" id="t_16_` + val.id + `"></td>
	              	<td><input class="form-control" type="text" value="` + val.s + `" id="s_` + val.id + `"></td>
	              	<td><input class="form-control" type="text" value="` + val.m + `" id="m_` + val.id + `"></td>
	              	<td><input class="form-control" type="text" value="` + val.l + `" id="l_` + val.id + `"></td>
	              	<td><input class="form-control" type="text" value="` + val.xl + `" id="xl_` + val.id + `"></td>
	              	<td><input class="form-control" type="text" value="` + val.xxl + `" id="xxl_` + val.id + `"></td>
	              	<td><input class="form-control" type="text" value="` + val.xxxl + `" id="xxxl_` + val.id + `"></td>
	              	<td>
	              		<span class="cursor w-100 btn btn-warning btn-xs" onclick="edit_medida(` + val.id + `);"><i class="fa fa-pencil"></i></span>
	              		<span class="cursor w-100 mt-1 btn btn-danger btn-xs" onclick="delete_medida(` + val.id + `);"><i class="fa fa-trash"></i></span>
	              	</td>
	            </tr>`);
			});
			$("#tabla_medidas").find('tbody').append(`<tr>
    				<td><textarea class="form-control" id="descripcion"></textarea></td>
	              	<th><input type="text" class="form-control" id="t_2"></th>      
	              	<td><input type="text" class="form-control" id="t_4"></td>
	              	<td><input type="text" class="form-control" id="t_6"></td>
	              	<td><input type="text" class="form-control" id="t_8"></td>
	              	<td><input type="text" class="form-control" id="t_10"></td>
	              	<td><input type="text" class="form-control" id="t_12"></td>
	              	<td><input type="text" class="form-control" id="t_14"></td>
	              	<td><input type="text" class="form-control" id="t_16"></td>
	              	<td><input type="text" class="form-control" id="s"></td>
	              	<td><input type="text" class="form-control" id="m"></td>
	              	<td><input type="text" class="form-control" id="l"></td>
	              	<td><input type="text" class="form-control" id="xl"></td>
	              	<td><input type="text" class="form-control" id="xxl"></td>
	              	<td><input type="text" class="form-control" id="xxxl"></td>
	              	<td><span class="w-100 cursor btn btn-xs btn-success" onclick="guardar_medidas('` + num_modelo + `');"><i class="fa fa-plus"></i></span></td>
	            </tr>`);
		});
	}
	...
	function get_instrucciones(num_modelo) {
		...
		$.post('core/app/view/fichaTecnica.php?parAccion=get_instruccion', {
			...
			if (obj.Result == "OK") {
				...
				html += `<tr>
		                        					<td colspan="2"><input type="text" id="maquina" placeholder="Maquina" class="form-control"></td>
		                        				</tr>
		                        				<tr>
		                        					<td></td>
		                        					<td colspan="2">
		                        						<button class="btn btn-warning" id="btn_instrucciones" onclick="guardar_maquina('` + num_modelo + `');">Guardar</button>
		                        					</td>
		                        				</tr>
                        				</table>
                      				</div>
					...
					$.each(instrucciones, function(index, val) {
						...
						$.each(val.pasos, function(i, v) {
							...
							html += `<tr>
                                      ...
                                      <input class="form-control" id="paso_` + v.id + `" value="` + v.paso + `" style="font-weight: bold; font-size: 1.5rem;">
                                    </td>
                            				<td>
                                      <textarea class="form-control" id="instruccion_` + v.id + `" style="resize: none;">` + v.instruccion + `</textarea></td>
                            				<td style="width: 50px;">
                                      <input class="form-control" id="orden_` + v.id + `" value="` + v.orden + `"></td>
                            				<td style="width: 50px;">
                            					<span class="cursor w-100 btn btn-warning btn-xs" onclick="edit_instruccion(` + v.id + `);"><i class="fa fa-pencil"></i></span>
	              								<span class="cursor w-100 mt-1 btn btn-danger btn-xs" onclick="eliminar_paso(` + v.id + `);"><i class="fa fa-trash"></i></span>
                        					</td>
                          				</tr>`;
						});
						html += `
                        				<tr>
                        					<td><input type="text" id="paso_` + val.id + `" placeholder="Paso" class="form-control"></td>
                        					<td><textarea type="text" id="instruccion_` + val.id + `" placeholder="Instruccion" class="form-control"></textarea></td>
                        					<td><input class="form-control" id="orden_` + val.id + `"></td>
                        					<td>
                        						<button class="btn btn-success" id="btn_instrucciones" onclick="guardar_instruccion(` + val.id + `,'` + num_modelo + `');"><i class="fa fa-plus"></i></button>
                        					</td>
                        				</tr>
                        			</table>
                  				</div>
	...
	$(document).ready(function() {
		...
		if (<?php echo Core::$user->kind; ?> == 5 || <?php echo Core::$user->kind; ?> == 1) {
